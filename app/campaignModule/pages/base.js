...
var CampaignBase = (function (_super) {
    __extends(CampaignBase, _super);
    function CampaignBase(campaignService, router) {
        _super.call(this);
    ...
    CampaignBase.prototype.changeSelectedView = function (option) {
        if (option.id == 0) {
    ...
    CampaignBase.prototype.view = function (item) {
        this.router.navigate(['/campaigns/view', { id: item.id }]);
    };
    CampaignBase.prototype.edit = function (item) {
        this.router.navigate(['/campaigns/edit', { id: item.id }]);
    };
    CampaignBase.prototype.newItem = function () {
        this.router.navigate(['/campaigns/edit/']);
    };
    CampaignBase = __decorate([
        core_1.Component({
...
exports.CampaignBase = CampaignBase;
